...
public class CacheContainerCountersResource extends SimpleResourceDefinition {
    ...
    public void registerChildren(ManagementResourceRegistration rr) {
        rr.registerSubModel(new StrongCounterResource(resolvePathHandler, runtimeRegistration));
        rr.registerSubModel(new WeakCounterResource(resolvePathHandler, runtimeRegistration));
    }
