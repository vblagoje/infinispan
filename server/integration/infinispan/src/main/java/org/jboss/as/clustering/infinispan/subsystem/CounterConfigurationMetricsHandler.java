 ...
 * @since 9.2
 */
public class CounterConfigurationMetricsHandler extends AbstractRuntimeOnlyHandler {

    public static final CounterConfigurationMetricsHandler INSTANCE = new CounterConfigurationMetricsHandler();
    ...
    protected void executeRuntimeStep(OperationContext context, ModelNode operation) throws OperationFailedException {        
        ...
        if (controller != null) {
            ...
            //we only have to attributes in CounterManagerConfiguration
